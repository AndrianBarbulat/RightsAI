    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-gold text-white rounded-full shadow-lg flex items-center justify-center hover:bg-gold-light transition-colors z-50"
          ...
          <div className="w-full sm:w-[400px] h-full sm:h-[600px] sm:max-h-[80vh] bg-cream sm:rounded-xl shadow-2xl flex flex-col">
            ...
            <div className="bg-navy text-white px-4 py-3 flex items-center justify-between sm:rounded-t-xl">
              <div className="flex items-center gap-2">
                <span className="font-heading text-lg font-bold">LawBot Ireland</span>
              </div>
              <div className="flex items-center gap-2">
                {!isEmpty && (
                  <button
              ...
              {isEmpty ? (
                <div className="text-center py-8">
                  <p className="text-navy font-body text-sm leading-relaxed">
                    Hello! I am LawBot Ireland. Ask me anything about Irish law, your rights, or legal
            ...
            <div className="p-3 border-t border-cream-dark bg-white sm:rounded-b-xl">
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="bg-gold text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gold-light transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
