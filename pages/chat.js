...
export default function About() {
  return (
    <>
      ...
      <Navbar />
      <main className="about-page" style={{ paddingTop: 'var(--navbar-height)' }}>
        <section className="about-page__section">
          <h1 className="about-page__title">About RightsAI</h1>
